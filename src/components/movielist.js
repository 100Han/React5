...
class MovieList extends Component {
    ...
    handleSelect(selectedIndex, e) {
        ...
        dispatch(setMovie(this.props.movies.movies[selectedIndex]));
    }
    ...
    render() {
                        ...
                        <Carousel.Item key={movie._id}>
                            <div>
                                <LinkContainer to={'/movie/'+movie._id} onClick={()=>this.handleClick(movie)}>
                                    <Nav.Link><Image className="image" src={movie.movieurl} thumbnail /></Nav.Link>
                                </LinkContainer>
                            </div>
                            <Carousel.Caption>
                                <h3>{movie.title}</h3>
        ...
        return (
            <MovieListCarousel movieList={this.props.movies.movies} />
        )
    }
}
